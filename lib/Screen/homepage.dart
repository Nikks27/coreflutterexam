  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("STUDENT DATA",style: TextStyle(color: Colors.white,fontSize: 23,fontWeight: FontWeight.w700),),
      ),
      ...
      floatingActionButton: InkWell(
        onTap: () {
          ...
          setState(() {
            StudentDataList.add(StudentDetails(name: student_name,Gird: student_grid,std: student_standard));
          });
